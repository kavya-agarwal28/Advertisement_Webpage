...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { comment: @advertisement.comment, image_url: @advertisement.image_url, text: @advertisement.text, title: @advertisement.title } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { comment: @advertisement.comment, image_url: @advertisement.image_url, text: @advertisement.text, title: @advertisement.title } }
