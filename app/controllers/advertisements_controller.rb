class AdvertisementsController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to advertisements_path, notice: "Not Authorized To Edit This Advertisement" if @advertisement.nil?
  end
  ...
  private
    ...
    def advertisement_params
      params.require(:advertisement).permit(:image_url, :title, :text, :comment, :user_id)
    end
end
